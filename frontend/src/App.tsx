  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      {acquisition && (
        <>
          <p>
            {acquisition.receiver_positions.length} receivers,{" "}
            {acquisition.files.length} shots
          </p>
          <table>
            <thead>
              <tr>
          ...
          <p>
            <strong>Sensor positions [m]:</strong>{" "}
            {acquisition.receiver_positions.join(", ")}
          </p>
          <p>
            <strong>Source positions [m]:</strong>{" "}
            {acquisition.source_positions.join(", ")}
          </p>
